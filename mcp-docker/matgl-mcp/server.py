...
from tools import (relax_crystal_structure_MatGL,
...
def main(port: int, transport: str = 'sse') -> int:
    ...
    logger.info(f"启动MatGL-MCP服务器，传输类型: {transport}, 端口: {port}")
