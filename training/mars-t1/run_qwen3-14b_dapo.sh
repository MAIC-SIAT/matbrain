...
mars_train_data_path=${MARS_TRAIN_DATA:-$SCRIPT_DIR/prepare_data/data_v1/train.parquet}
mars_test_data_path=${MARS_TEST_DATA:-$SCRIPT_DIR/prepare_data/data_v1/test.parquet}
...
# wandb
project_name=mars
experiment_name=qwen3-14b_dapo-new-think-reward
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.total_epochs=1 $@ > run_qwen3-14b_dapo-20251203.log 2>&1
